...
CREATE INDEX languages_enabled_idx
...
CREATE INDEX problems_visibility_created_idx 
...
CREATE INDEX problem_tags_tag_idx
...
CREATE INDEX test_groups_problem_idx
  ON test_groups (problem_id);

CREATE UNIQUE INDEX test_groups_problem_order_uq
...
CREATE INDEX testcases_problem_idx ON testcases (problem_id);
CREATE INDEX testcases_group_idx   ON testcases (group_id);

CREATE UNIQUE INDEX testcases_problem_external_uq
  ON testcases (problem_id, external_id);

CREATE UNIQUE INDEX testcases_problem_order_uq
...
CREATE INDEX submissions_problem_created_idx
...
CREATE INDEX runs_submission_idx ON runs (submission_id);
CREATE INDEX runs_state_queued_idx ON runs (state, queued_at) 
...
CREATE INDEX execution_summaries_verdict_idx
...
CREATE INDEX testcase_results_run_idx
  ON testcase_results (run_id);

CREATE INDEX testcase_results_testcase_idx
  ON testcase_results (testcase_id);

CREATE INDEX testcase_results_verdict_idx
...
CREATE INDEX security_events_run_idx
